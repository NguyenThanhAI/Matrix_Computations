...
\begin{algorithm}
    ...
    \begin{algorithmic}
        \State{Cho ma trận $A$ không kỳ dị, $b$, chuẩn phần dư $\epsilon$ cho phép, gán $q_1 \leftarrow b/\lVert b \rVert$}
        \For {$n=1,2,3,\dots$}
            ...
            \State {$g_n \leftarrow G(n, n+1, \theta_n)G(n-1, n, \theta_{n-1})G(n-2, n-1, \theta_{n-2})\dots G(1, 2, \theta_1) \beta e_1$}
